...
# Filtrar por Razon social != Comercial Nutresa S.A.S
base_bo_filtrada = Filtrar_por_valores_excluidos(
    df=base_bo, columna=RAZON_SOCIAL, valores_excluir=["Comercial Nutresa S.A.S"]
)
# Filtrar Subcanal
#base_bo_filtrada = Filtrar_por_valores_excluidos(
#    df=base_bo,
...
base_bo_filtrada = Cambiar_tipo_dato_multiples_columnas(
    base=base_bo_filtrada, list_columns=COLS_SUM_PLANTILLA1_TD_VD, type_data=float
)
